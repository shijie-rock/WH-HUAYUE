 ...
 * @version 1.0.0
 */
public class QueryEntitySupListAction extends ActionImpl {
	...
	protected int performExecute(ActionContext atx) {
		...
		try {
			...
			PageQuery pageQuery=TmInsCheckEntityPOFactory.queryInsCheckEntitySupList(conn, entCode, entName, "1".equals(includeStop), customPageSize);
			...
			e.printStackTrace();
			logger.error("QueryEntitySupListAction error:"+e.getMessage());
			atx.setErrorContext("BUSI_DATA_ENT_SUP_QUERY_LIST_ACTION_ERR_9000", "查询检查对象大类列表信息出错", e);
			return 0;
		}

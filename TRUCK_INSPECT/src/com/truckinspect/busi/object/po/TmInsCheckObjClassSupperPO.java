...
public class TmInsCheckObjClassSupperPO implements DataBean{
	...
	private String checkEntSupCode;
	...
	public void setCheckEntSupCode(String checkEntSupCode){
		this.checkEntSupCode=checkEntSupCode;
	}

	public String getCheckEntSupCode(){
		return this.checkEntSupCode;
	}

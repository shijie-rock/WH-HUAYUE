...
public class YouBusGroupPOListTag extends SimpleTagSupport {
	...
	public void doTag() throws IOException{
		...
		if(agentId!=null){
			if(TruckInsNativeCacheService.getGroupListCache("AGENT_GROUP_LIST_CACHE", (String)agentId)!=null)
				request.setAttribute("GROUP_PO_LIST", TruckInsNativeCacheService.getGroupListCache("AGENT_GROUP_LIST_CACHE",(String)agentId ));
				System.out.println(TruckInsNativeCacheService.getGroupListCache("AGENT_GROUP_LIST_CACHE",(String)agentId ));

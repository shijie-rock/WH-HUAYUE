 ...
 * @version 1.0.0
 */
public class TruckInsNativeCacheUtil {

	/**
	 * 创建一个新的实例 TruckInsNativeCacheUtil.
	 *
	 */
	static Logger logger=Logger.getLogger(TruckInsNativeCacheUtil.class);
	
	public TruckInsNativeCacheUtil() {
		// TODO Auto-generated constructor stub
	}
	
	/**
	 * 根据数据字典Code 获取缓存对象
	 * 方   法  名:getCacheDataDic
	 * 方法描述:
	 * 参         数:@param dicCode
	 * 参         数:@return
	 * 返   回  值:TsDataDicPO
	 ...
	 * @since  1.0.0
	 */
	public static TsDataDicPO getCacheDataDic(String dicCode){
//		DATA_DIC_MAP_CACHE
		Cache dicCache=TruckInsNativeCacheService.getCache("DATA_DIC_MAP_CACHE");
		if(dicCache!=null&&dicCache.get(dicCode)!=null){
			return (TsDataDicPO)dicCache.get(dicCode).getValue();
		}
		return null;
	}

...
public class YBUtility {
	...
	*/
	public static String getDicDescByCode(String typeCode,String code){
		...
		Element e1=TruckInsNativeCacheService.DATA_DIC_CACHE.get(typeCode);
...
//	}
	...
	public static String getMemberName(ActionContext atx){
		String name=atx.getStringValue(YBCommonContant.SESSION_USER_NAME);

...
<div class="tree well">
 <ul>
  <li>
   <span id="Parent_1"><i class="glyphicon glyphicon-folder-open" ></i> Parent</span> <a href="">Goes somewhere</a>
   <ul>
    <li>
  ...
  <li>
   <span id="Parent_2"><i class="glyphicon glyphicon-folder-open" ></i> Parent2</span> <a href="">Goes somewhere</a>
   <ul>
    <li>

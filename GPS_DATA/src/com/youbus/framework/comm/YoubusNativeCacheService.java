...
import com.youbus.framework.basebean.TbAppInfoPO;
import com.youbus.framework.basebean.TsAppAllInfoPO;
import com.youbus.framework.basebean.TsDataDicPO;
 ...
 * @version 1.0.0
 */
public class YoubusNativeCacheService implements Service {
	...
	public static Cache AGENT_ASSIGN_PANEL_CACHE ; //调度派车看板
	
	public static Cache TS_APP_ALL_INFO_CACHE ; //TS_APP_ALL_INFO
	
	public static Cache AGENT_MOBILE_CHECK_CODE_CACHE;//车队平台手机验证码缓存
	
	public static Cache AGENT_GROUP_LIST_CACHE;//车队调度组
	public static Cache AGENT_MEMBER_GROUP_LIST_CACHE;//调度对应调度组
	...
	public String getName() {
		// TODO Auto-generated method stub
		return YoubusNativeCacheService.class.getName();
	}
	...
	public void initialize(Map arg0) throws FrameException {
		...
		//初始化数据字典
		System.out.println("initDataDic begin");
		initDataDic(manager,conn);
		System.out.println("initDataDic end");
		System.out.println("initAppInfo begin");
		initAppInfo(conn);
		System.out.println("initAppInfo end :="+YoubusNativeCacheService.APP_NO_PREFIX);
		
//		System.out.println("initDriverAndVehicle begin");
//		initDriverAndVehicle(manager, conn);
//		System.out.println("initDriverAndVehicle end");
...
//	}
	...
	public static Cache getCache(String cacheName){
		...
		else if("DATA_DIC_CACHE".equalsIgnoreCase(cacheName))return DATA_DIC_CACHE;
